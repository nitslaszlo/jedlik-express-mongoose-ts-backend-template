...
export default class App {
    ...
    private initializeMiddlewares() {
        ...
        this.app.use((req, res, next) => {
            ...
            res.header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept, Authorization, My-Suti");
            res.header("Access-Control-Allow-Credentials", "true");
            res.header("Access-Control-Expose-Headers", "My-Suti");
